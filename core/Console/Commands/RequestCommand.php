...
class RequestCommand extends BaseCommand
{
    ...
    public function handle($input, $output)
    {
        ...
        elseif (file_exists(config('path.request.base') . "/{$request}.php"))
        {
    ...
    {
        $file = config('path.console.foundation_command_base') . "/templates/request.php.dist";
        if (file_exists($file))
        {
            ...
            $file_path = config('path.request.base') . "/{$request}.php";
